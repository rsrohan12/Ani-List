...
export function AnimeListContent() {
  ...
  return (
    ...
    {query.length <= 0 && <span className="text-2xl border-b-2 border-cyan-700 max-lg:ml-6">Search to see the <span className="text-pink-600/75 text-2xl ">details...</span> </span>}
